...
namespace EmmasLibrary.EmployeeDataSetTableAdapters {
    ...
    public partial class employeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[employee] SET [empFirst] = @empFirst, [empLast] = @empLast, [posID]" +
                " = @posID WHERE (([id] = @Original_id));\r\nSELECT id, empFirst, empLast, posID FR" +
                "OM employee WHERE (id = @id)";
